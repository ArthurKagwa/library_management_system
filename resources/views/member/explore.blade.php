<x-app-layout>
    ...
    <div class="min-h-screen bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100 dark:from-gray-800 dark:via-gray-700 dark:to-gray-600">
        <div class="p-4">
            ...
            <div class="max-w-7xl mx-auto px-4">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
                    @forelse($books as $book)
                        <div class="flex flex-col items-center bg-white dark:bg-gray-800 border rounded-lg shadow-md hover:shadow-xl transition-shadow transform hover:scale-105 duration-300">
                            @if($book->image)
